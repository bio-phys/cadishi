...
static PyObject *__pyx_pw_7cadishi_6kernel_6c_pydh_1histograms(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  {
    static PyObject **__pyx_pyargnames[] = {&__pyx_n_s_r_ptr,&__pyx_n_s_nel_ptr,&__pyx_n_s_histo_ptr,&__pyx_n_s_r_max,&__pyx_n_s_mask_ptr,&__pyx_n_s_box_ptr,&__pyx_n_s_box_type_id,&__pyx_n_s_precision,&__pyx_n_s_n_threads,&__pyx_n_s_check_input,&__pyx_n_s_do_histo2_only,0};
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        ...
        if (likely((values[1] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_nel_ptr)) != 0)) kw_args--;
          ...
          __Pyx_RaiseArgtupleInvalid("histograms", 1, 11, 11, 1); __PYX_ERR(0, 56, __pyx_L3_error)
        }
        case  2:
        if (likely((values[2] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_histo_ptr)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("histograms", 1, 11, 11, 2); __PYX_ERR(0, 56, __pyx_L3_error)
        }
        case  3:
        if (likely((values[3] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_r_max)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("histograms", 1, 11, 11, 3); __PYX_ERR(0, 56, __pyx_L3_error)
        }
        case  4:
        if (likely((values[4] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_mask_ptr)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("histograms", 1, 11, 11, 4); __PYX_ERR(0, 56, __pyx_L3_error)
        }
        case  5:
        if (likely((values[5] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_box_ptr)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("histograms", 1, 11, 11, 5); __PYX_ERR(0, 56, __pyx_L3_error)
        }
        case  6:
        if (likely((values[6] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_box_type_id)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("histograms", 1, 11, 11, 6); __PYX_ERR(0, 56, __pyx_L3_error)
        }
        case  7:
        if (likely((values[7] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_precision)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("histograms", 1, 11, 11, 7); __PYX_ERR(0, 56, __pyx_L3_error)
        }
        case  8:
        if (likely((values[8] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_n_threads)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("histograms", 1, 11, 11, 8); __PYX_ERR(0, 56, __pyx_L3_error)
        }
        case  9:
        if (likely((values[9] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_check_input)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("histograms", 1, 11, 11, 9); __PYX_ERR(0, 56, __pyx_L3_error)
        }
        case 10:
        if (likely((values[10] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_do_histo2_only)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("histograms", 1, 11, 11, 10); __PYX_ERR(0, 56, __pyx_L3_error)
        }
      }
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, pos_args, "histograms") < 0)) __PYX_ERR(0, 56, __pyx_L3_error)
      }
    ...
    __pyx_v_r_max = __pyx_PyFloat_AsFloat(values[3]); if (unlikely((__pyx_v_r_max == (float)-1) && PyErr_Occurred())) __PYX_ERR(0, 59, __pyx_L3_error)
    __pyx_v_mask_ptr = ((PyArrayObject *)values[4]);
    __pyx_v_box_ptr = ((PyArrayObject *)values[5]);
    __pyx_v_box_type_id = __Pyx_PyInt_As_int(values[6]); if (unlikely((__pyx_v_box_type_id == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 62, __pyx_L3_error)
    __pyx_v_precision = __Pyx_PyInt_As_int(values[7]); if (unlikely((__pyx_v_precision == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 63, __pyx_L3_error)
    __pyx_v_n_threads = __Pyx_PyInt_As_int(values[8]); if (unlikely((__pyx_v_n_threads == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 64, __pyx_L3_error)
    __pyx_v_check_input = __Pyx_PyObject_IsTrue(values[9]); if (unlikely((__pyx_v_check_input == ((bool)-1)) && PyErr_Occurred())) __PYX_ERR(0, 65, __pyx_L3_error)
    __pyx_v_do_histo2_only = __Pyx_PyObject_IsTrue(values[10]); if (unlikely((__pyx_v_do_histo2_only == ((bool)-1)) && PyErr_Occurred())) __PYX_ERR(0, 66, __pyx_L3_error)
  }
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("histograms", 1, 11, 11, PyTuple_GET_SIZE(__pyx_args)); __PYX_ERR(0, 56, __pyx_L3_error)
  __pyx_L3_error:;
  __Pyx_AddTraceback("cadishi.kernel.c_pydh.histograms", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  if (unlikely(!__Pyx_ArgTypeTest(((PyObject *)__pyx_v_r_ptr), __pyx_ptype_5numpy_ndarray, 1, "r_ptr", 0))) __PYX_ERR(0, 56, __pyx_L1_error)
  if (unlikely(!__Pyx_ArgTypeTest(((PyObject *)__pyx_v_nel_ptr), __pyx_ptype_5numpy_ndarray, 1, "nel_ptr", 0))) __PYX_ERR(0, 57, __pyx_L1_error)
  if (unlikely(!__Pyx_ArgTypeTest(((PyObject *)__pyx_v_histo_ptr), __pyx_ptype_5numpy_ndarray, 1, "histo_ptr", 0))) __PYX_ERR(0, 58, __pyx_L1_error)
  if (unlikely(!__Pyx_ArgTypeTest(((PyObject *)__pyx_v_mask_ptr), __pyx_ptype_5numpy_ndarray, 1, "mask_ptr", 0))) __PYX_ERR(0, 60, __pyx_L1_error)
  if (unlikely(!__Pyx_ArgTypeTest(((PyObject *)__pyx_v_box_ptr), __pyx_ptype_5numpy_ndarray, 1, "box_ptr", 0))) __PYX_ERR(0, 61, __pyx_L1_error)
  __pyx_r = __pyx_pf_7cadishi_6kernel_6c_pydh_histograms(__pyx_self, __pyx_v_r_ptr, __pyx_v_nel_ptr, __pyx_v_histo_ptr, __pyx_v_r_max, __pyx_v_mask_ptr, __pyx_v_box_ptr, __pyx_v_box_type_id, __pyx_v_precision, __pyx_v_n_threads, __pyx_v_check_input, __pyx_v_do_histo2_only);
 ...
 */
  ...
  __pyx_t_1 = __Pyx_PyInt_From_int(__pyx_v_exit_status); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 99, __pyx_L1_error)
 ...
 *                np.ndarray histo_ptr,
 */
  __pyx_tuple__10 = PyTuple_Pack(16, __pyx_n_s_r_ptr, __pyx_n_s_nel_ptr, __pyx_n_s_histo_ptr, __pyx_n_s_r_max, __pyx_n_s_mask_ptr, __pyx_n_s_box_ptr, __pyx_n_s_box_type_id, __pyx_n_s_precision, __pyx_n_s_n_threads, __pyx_n_s_check_input, __pyx_n_s_do_histo2_only, __pyx_n_s_n_tot, __pyx_n_s_n_El, __pyx_n_s_n_bins, __pyx_n_s_cfg, __pyx_n_s_exit_status); if (unlikely(!__pyx_tuple__10)) __PYX_ERR(0, 56, __pyx_L1_error)
 ...
 *                np.ndarray histo_ptr,
 */
  __pyx_t_1 = PyCFunction_NewEx(&__pyx_mdef_7cadishi_6kernel_6c_pydh_1histograms, NULL, __pyx_n_s_cadishi_kernel_c_pydh); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 56, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
